...
async def generate_answers_async(client:AsyncOpenAI, keyword:str, question:str, model:str="gpt-3.5-turbo",answer_generator_prompt:str=ANSWER_GENERATOR_PROMPT, **kwargs) -> list[Choice]:
    completion = await client.chat.completions.create(
        model=model,
        messages=[
